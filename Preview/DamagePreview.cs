...
{
    /// <inheritdoc cref="DamagePreview(DynamicVar, Func{Creature?, int}, CardModel)"/>
    public DamagePreview(DynamicVar damageVar, CardModel owner) : this(damageVar, default(DynamicVar), owner) { }

    /// <inheritdoc cref="DamagePreview(DynamicVar, Func{Creature?, int}, CardModel)"/>
    /// <param name="damageVar">The <see cref="DynamicVar"/> that this is linked to.</param>
    ...
    public DamagePreview(DynamicVar damageVar, int hitCount, CardModel owner) : this(damageVar, target => hitCount, owner) { }
    ...
    /// <param name="owner">The <see cref="CardModel"/> that this is linked to.</param>
    public DamagePreview(DynamicVar damageVar, DynamicVar? hitCountVar, CardModel owner) : this(damageVar, PreviewManager.HitCountFromDynamicVarFunc(hitCountVar), owner) { }
    ...
    public DamagePreview(DynamicVar damageVar, Func<Creature?, int> hitCountFunc, CardModel card)
    {
